    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="col mb-3">
            ...
            <input type="text" name="lokasi_id" class="form-control" placeholder="Lokasi"
                value="{{ $kerusakans->lokasi_id }}" readonly>
        </div>
        <div class="col mb-3">
        ...
        <input type="text" name="users_id" class="form-control" placeholder="Nama Pelapor"
            value="{{ $kerusakans->users_id }}" readonly>

        <div class="col mb-3">
            <label class="form-label">Nama Pelapor</label>
            <input type="text" name="users_id" class="form-control" placeholder="Nama Pelapor"
                value="{{ $kerusakans->deskripsi_kerusakan }}" readonly>
        </div>

        <div class="col mb-3">
            <label class="form-label">Created At</label>
            <input type="text" name="created_at" class="form-control" placeholder="Created At"
                value="{{ $kerusakans->created_at }}" readonly>
        </div>
        <div class="col mb-3">
            <label class="form-label">Updated At</label>
            <input type="text" name="updated_at" class="form-control" placeholder="Updated At"
                value="{{ $kerusakans->updated_at }}" readonly>
