<div class="modal fade" id="asets_show" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-12">
              <label for="kode_aset"><b>Kode Barang</b></label>
              <input type="text" name="" class="form-control" id="kode_aset" placeholder="" disabled>
            </div>
          </div>
          <hr>
          <div class="row">
